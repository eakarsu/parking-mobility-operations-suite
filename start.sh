...
PORT="${PORT:-4990}"
DB_NAME="${PGDATABASE:-parking_mobility_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Parking Mobility Operations Suite"
echo "======================================="
echo
...
echo "Starting parking mobility operations suite frontend on http://localhost:$PORT"
echo "Login: admin@parking-mobility-operations.local / admin123"
