export const AUTH_COOKIE = 'parking_mobility_operations_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@parking-mobility-operations.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@parking-mobility-operations.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@parking-mobility-operations.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
